...
void MyOpenGLWidget::paintGL()
{
    ...
    case MyOpenGLWidget::Rect:
    {
        ...
        */
        ...
        // 这里让光照位置与相机位置重合
        m_shaderProgram.setUniformValue("light.position",  m_camera.m_cameraPos);
        // 这里聚光方向用了camera的方向代替了
        m_shaderProgram.setUniformValue("light.spotDirection", m_camera.m_cameraLookAtFrontDirection);
        m_shaderProgram.setUniformValue("light.cutoffAngle", (float)cos(12.5f*M_PI/180) );
        m_shaderProgram.setUniformValue("light.outerCutoffAngle", (float)cos(17.5f*M_PI/180));
