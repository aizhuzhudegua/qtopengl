...
void MyOpenGLWidget::paintGL()
{
    ...
    case MyOpenGLWidget::Rect:
    {
        ...
        // 设置光源的环境光强度较弱
        m_shaderProgram.setUniformValue("light.ambient", ambientColor/*QVector3D(0.2f, 0.2f, 0.2f)*/);
        // 设置光源的光为较暗
        m_shaderProgram.setUniformValue("light.diffuse", diffuseColor/*QVector3D(0.5f, 0.5f, 0.5f)*/);
        // 设置镜面光为最大强度强度发光
