...
MyOpenGLWidget::~MyOpenGLWidget()
{
    ...
    m_singleColorShaderProgram.removeAllShaders();
...
void MyOpenGLWidget::initializeGL()
{
    ...
    */
    ...
    m_singleColorShaderProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,":/shaders/shaders/vertex_shader.vert");
    m_singleColorShaderProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,":/shaders/shaders/singleColor.frag");
    m_singleColorShaderProgram.link();
...
void MyOpenGLWidget::paintGL()
{
    ...
    */
    ...
    m_singleColorShaderProgram.setUniformValue("projection", m_projection);
    m_singleColorShaderProgram.setUniformValue("view", m_view);
    m_singleColorShaderProgram.release();
    // 允许向模板缓冲区写入值
    glStencilMask(0xFF);
    foreach(auto modelInfo,m_models){
        ...
        */
        ...
        m_model.scale(1.1);
        m_singleColorShaderProgram.bind();
        m_singleColorShaderProgram.setUniformValue("model", m_model);
