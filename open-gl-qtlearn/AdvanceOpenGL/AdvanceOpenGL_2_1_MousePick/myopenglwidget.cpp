...
MyOpenGLWidget::~MyOpenGLWidget()
{
    ...
    if (m_pmodel != nullptr)
        delete m_pmodel;
    if (m_boxDiffuseTex != nullptr)
        delete m_boxDiffuseTex;
...
void MyOpenGLWidget::initializeGL()
{
    ...
    */
    ...
    m_boxDiffuseTex=new QOpenGLTexture(QImage(":/images/images/diffuse_map.png").mirrored());
    m_planeDiffuseTex=new QOpenGLTexture(QImage(":/images/images/specular_map.png").mirrored());
