...
MyOpenGLWidget::~MyOpenGLWidget()
{
    ...
    m_reflectionShaderProgram.release();
    m_reflectionShaderProgram.removeAllShaders();
...
void MyOpenGLWidget::initializeGL()
{
    ...
    */
    ...
    m_reflectionShaderProgram.link();
...
void MyOpenGLWidget::paintGL()
{
    ...
    */
    ...
    m_reflectionShaderProgram.setUniformValue("projection", m_projection);
    m_reflectionShaderProgram.setUniformValue("view", m_view);
    m_reflectionShaderProgram.setUniformValue("viewPos",m_camera.m_cameraPos);
	m_reflectionShaderProgram.setUniformValue("skybox", 0);
	m_cubeMap->bind(0);
    foreach(auto modelInfo,m_models){
        ...
        m_reflectionShaderProgram.setUniformValue("model", m_model);
