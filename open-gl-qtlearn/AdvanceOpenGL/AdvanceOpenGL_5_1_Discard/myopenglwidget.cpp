...
// 草的集合
std::vector<QVector3D> vegetation;
...
void MyOpenGLWidget::initializeGL()
{
    ...
    */
    ...
    // 草纹理
    m_grassTexture = new QOpenGLTexture(QImage(":/images/images/grass.png"));

    m_planeMesh=processMesh(planeVertices,6,m_planeDiffuseTex->textureId());
    m_grassMesh=processMesh(transparentVertices,6,m_grassTexture->textureId());
}
