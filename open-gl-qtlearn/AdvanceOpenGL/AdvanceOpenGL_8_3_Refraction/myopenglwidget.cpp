...
MyOpenGLWidget::~MyOpenGLWidget()
{
    ...
    m_refractionShaderProgram.release();
    m_refractionShaderProgram.removeAllShaders();
...
void MyOpenGLWidget::initializeGL()
{
    ...
    */
    ...
    m_refractionShaderProgram.link();
...
void MyOpenGLWidget::paintGL()
{
    ...
    */
    ...
    m_refractionShaderProgram.setUniformValue("projection", m_projection);
    m_refractionShaderProgram.setUniformValue("view", m_view);
    m_refractionShaderProgram.setUniformValue("viewPos",m_camera.m_cameraPos);
    m_refractionShaderProgram.setUniformValue("skybox", 0);
    m_cubeMap->bind(0);
    foreach(auto modelInfo,m_models){
        ...
        m_refractionShaderProgram.setUniformValue("model", m_model);
