...
float vertices[] = {
    0.5f,0.5f,0.0f,    1.0f,0.0,0.0,   2.0f,2.0f,// top right
    0.5f,-0.5f,0.0f,   0.0,1.0f,0.0,   2.0f,-1.0f,// top down

    -0.5f,-0.5f,0.0f,  0.0,0.0,1.0f,   -1.0f,-1.0f,// left down
    -0.5f,0.5f, 0.0f,  1.0f,1.0f,0.0,  -1.0f,2.0f // left up
};// left up
